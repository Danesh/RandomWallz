...
class PreferenceHelper {
    ...
    static final String WALLPAPER_CHANGED_TIME = "wallpaper_changed_time";
    ...
    public long getWallpaperChangedTime() {
        return mSharedPreferences.getLong(WALLPAPER_CHANGED_TIME, 0);
    }
